...
> * **441 test functions** (`docs/FACTS.md` counts them from source;
...
- **441 test functions** (offline, `python -m pytest`; counted from
...
python -m pytest                      # 441 test functions, offline
